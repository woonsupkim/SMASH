        ...
        '<table style = "width:90%; background-color:white;">',
          ...
          '<td style = "width:65%">',
            '<div style = "background-color:rgba(0,100,0,0.2); border-radius:10px; padding:15px 25px 15px 25px;">',
              ...
              '<div class="pentagon-graph">',
        '<div class="pentagon-bar" style="transform: rotate(0deg); height:', round(plyr2$p[1,ab] + 20, 0), '%;"></div>',
        '<div class="pentagon-bar" style="transform: rotate(72deg); height:', round(plyr2$p[2,ab] * plyr2$p[1,ab] + 10, 0), '%;"></div>',
        '<div class="pentagon-bar" style="transform: rotate(144deg); height:', round(plyr2$p[3,ab], 0), '%;"></div>',
        '<div class="pentagon-bar" style="transform: rotate(216deg); height:', round(plyr2$p[4,ab], 0), '%;"></div>',
        '<div class="pentagon-bar" style="transform: rotate(288deg); height:', round(plyr2$p[5,ab] * 1.8, 0), '%;"></div>',
        '</div>',
        '</div>',
        '</td>',
        '</tr>',
