            ...
            column(
              ...
              wellPanel(
                style = paste0(
                  ...
                  'box-shadow: 10px 10px 10px 0 rgba(255,165,0,0.75);'
                ),
                # _scoreboard----
                uiOutput('scorebd')
              ),
              ...
              wellPanel(
                ...
                h4(
                  ifelse(
                    ...
                    'Click the \'Simulate\' Button to start the first 10 match simulations.'
                  )
                ),
                # radioGroupButtons(
                #   inputId = 'nSim',
                #   label = 'Number of Matches',
                #   choices = c(seq(10, 100, 10)),
                #   selected = 10,
                #   status = 'primary',
                #   size = 'sm',
                #   justified = TRUE,
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    actionBttn(
                      inputId = 'sim',
                      label = ifelse(sim$i >= sim$n, 'Simulate 10 More', 'Simulate'),
                      style = 'unite',
                      color = 'warning',
                      size = 'md',
                      block = TRUE,
      ...
      wellPanel(
        ...
        fluidRow(
          column(
            width = 3,
            wellPanel(
              style = 'background-color:rgba(50,50,50,0.5); border-width:0;',
              h4('Matches Won'),
              h1(
                style = 'color:lime; font-size:70px;',
                ww[1]
              ),
              h4(
                style = 'color:lime;',
          ...
          column(
            ...
            wellPanel(
              ...
              h4('Matches Won'),
              h1(
                style = 'color:magenta; font-size:70px;',
                ww[2]
              ),
              h4(
                style = 'color:magenta;',
    ...
    if (sim$l[i,j] > 0) {
      ...
      return(
          ...
          style = paste0(
            ...
            'padding: ', 
            switch(j, '2px 0 2px 5px; ', '2px 5px 2px 0; '),
    ...
    if (input$tabs == 3) {
      div(
        ...
        div(
          ...
          p('Click on an image to see their bio.'),
          fluidRow(
            lapply(
              1:6, 
              function(i) {
